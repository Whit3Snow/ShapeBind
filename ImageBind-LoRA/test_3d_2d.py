...
#              ".assets/phone.jpg"]
image_paths=[
    ".assets/crosspoint_image/chair.png",
    ".assets/crosspoint_image/airplane.png",
    ".assets/crosspoint_image/car.png",
    ".assets/crosspoint_image/display.png",
    ".assets/crosspoint_image/phone.png",
]

pc_paths=[".assets/crosspoint_ply/chair.ply",
          ".assets/crosspoint_ply/plane.ply",
          ".assets/crosspoint_ply/phone.ply"]
...
# breakpoint()
model = imagebind_model.imagebind_huge(pretrained=True, device=device, model_path="/root/volume/.checkpoints/mgpu_3d_2d_full_1024_v1/shapebind-epoch=57-val_loss=2.30.ckpt")
