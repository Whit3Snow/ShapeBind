"""
Based on 'https://github.com/openai/point-e/blob/main/point_e/models/configs.py'
Model configuration code for Point-E diffusion decoder
"""
...
# from models.sdf import CrossAttentionPointCloudSDFModel
...
MODEL_CONFIGS = {
    ...
    "base1B": {
        ...
        "layers": 24,
        "n_ctx": 1024,
        # TODO: Change to PointDiffusionTransformer
        "name": "CLIPImageGridPointDiffusionTransformer",
        "output_channels": 12,
        "time_token_cond": True,
        "width": 2048,
