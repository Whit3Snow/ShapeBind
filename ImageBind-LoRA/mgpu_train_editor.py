...
class ChangeIt3M(L.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        # Optional: You can also add weight_decay if you want to use L2 regularization
        # optimizer = optim.SGD(self.parameters(), lr=self.hparams.lr, momentum=0.9, weight_decay=self.hparams.weight_decay)
